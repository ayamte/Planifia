...
public class APIMainActivity extends Activity {
    /**
  ...
  HttpTransport transport = new ApacheHttpTransport();
    ...
    private void clearAuthorizationData() {
        ...
        editor.remove(PREF_ACCOUNT_NAME); // Clear the selected account name
        editor.clear(); // Clear all other authorization data as well
        editor.apply();
    }
    ...
    private void refreshResults() {
        if (credential.getSelectedAccountName() == null) {
            ...
            if (isDeviceOnline()) {
                new ApiAsyncTask(APIMainActivity.this).execute();
            } else {
